...
var World = {
	...
	*/
	...
	requestDataFromServer: function requestDataFromServerFn(lat, lon) {
		...
		var userData = {ServerInformation.POIDATA_SERVER_ARG_LAT: lat, ServerInformation.POIDATA_SERVER_ARG_LON: lon, ServerInformation.POIDATA_SERVER_ARG_NR_POIS: "20"};

		var jqxhr = $.post(serverUrl, userData, function(data) {
